    ...
    if(isset($_GET['step'])){
        if($_GET['step'] === 'url'){
            ...
            if(!empty($_GET['api_url'])){
                ...
                $txt = file_get_contents($api_env_path);
                ...
                <div class="tab-content">
                                ...
                                <div class="col-md-12 cta-contents">
                                    ...
                                    <div class="cta-desc">
                                        <p>Depuis quelle URL allez vous accèder au site ?<br/>
                                            ...
                                            <br/>
                                            <button type="button" class="btn btn-default" onclick="saveURL()">Sauvegarder</button>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" role="tabpanel" id="complete">
                        ...
                        <div class="bs-calltoaction bs-calltoaction-primary">
                            <div class="row">
                                <div class="col-md-12 cta-contents">
                                    <h1 class="cta-title">Terminer l'installation</h1>
                                    <div class="cta-desc">
                                        <p>
                                          Votre version personnalisée est bientot terminée.<br/>
                                          Il reste plus qu'à lancé la compilation.<br/>
                        ...
                        <ul class="list-inline pull-right">
                            <li><button type="button" class="btn btn-primary " onclick="build()">Terminer</button></li>
                        </ul>
                    </div>
...
<script>
    function saveURL(){
        $.ajax({
            url : '/?step=url&api_url='+$('#api_url').val()+'&www_url='+$('#www_url').val(),
            type : 'GET',
            dataType : 'html',
